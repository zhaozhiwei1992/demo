...
//    	System.out.println("starting");
    ...
    public void environmentPrepared(ConfigurableEnvironment environment) {
        ...
        SystemEnvironment.initEnvironment(environment);
    ...
    public void contextLoaded(ConfigurableApplicationContext context) {
        ...
        if (port != null) {
            ...
            SystemEnvironment.setProperty("com.atomikos.icatch.console_file_name", "rm" + microServiceName + "-" + port + ".out");
            SystemEnvironment.setProperty("com.atomikos.icatch.log_base_name", "rmlog" + microServiceName + "-" + port + ".log");
