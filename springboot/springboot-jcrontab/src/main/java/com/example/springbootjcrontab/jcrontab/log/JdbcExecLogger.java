...
public class JdbcExecLogger extends NullLogger implements Logger {

    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(JdbcExecLogger.class);

    @Override
    public void init() {
        logger.info("...............ExecLogger init........");
    }
