...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("templates/Excel.java.vm");
		templates.add("templates/index.vue.vm");
		templates.add("templates/add-or-update.vue.vm");
		templates.add("templates/mysql.vm");
		templates.add("templates/sqlserver.vm");
		templates.add("templates/oracle.vm");
		templates.add("templates/postgresql.vm");
		return templates;
	}
