...
import com.example.config.PostgresqlProperties;
 ...
 */
@Component
public class PostgresqlConnTestService {

    @Autowired
    private PostgresqlProperties postgresProperties;
        ...
        for (int j = 0; j < nThreads; j++) {
            executorService.execute(() -> {
                ...
                try {
                    ...
                    final Connection connection = DriverManager.getConnection(postgresProperties.getUrl()
